  ...
  return (
    <div className='App'>
      <DataContext.Provider value={{ prodList, purList, setPurList }}>
        <div className='App'>
          <Header isLogin={isLogin} onLogout={onLogout} onRequestPage={onRequestPage} loginInfo={loginInfo} onJoin={onJoin} />
          {location.pathname === '/' ? <MainDefault onLoginSubmit={onLoginSubmit} isLogin={isLogin} loginInfo={loginInfo} onJoin={onJoin} handleLogin={handleLogin} /> : <Main onLoginSubmit={onLoginSubmit} isLogin={isLogin} loginInfo={loginInfo} onJoin={onJoin} onDelete={onDelete} handleLogin={handleLogin} />}
          <Footer />
        </div>
