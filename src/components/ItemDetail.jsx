  ...
  return ( 
    <div className="itembox">
      ...
      <div style={{ marginLeft: "20px" }}>
        <h4>{name}</h4><br />
        <h4>₩ {price.toLocaleString()}</h4><br />
        <select style={{width:80, height:30, textAlign: "center", border: '2px solid #ccc', borderRadius: '5px'} }>
      ...
      <p>{currentProduct.description}</p>
        ...
        <button className="itembox-button" onClick={buyProduct}>구매</button>
      </div>
      </div>
      ...
      >
        <div>
          ...
          <br></br>
          <button className="itembox-button" onClick={closeAlert }>닫기</button>
          </div>
      </Modal>
